...
export function FollowupDojo() {
  ...
  const scenarios = [
    ...
    { id: 'angry_and_disappointed', label: '😡😞 غاضب وخائب', description: 'غاضب من النتائج وخائب', difficulty: 'صعب جداً', prompt: 'أنت عميل حالي غاضب جداً وخائب الأمل. بتقول: "النتائج ما جاءت زي ما وعدتوني! الـ leads نقصت والميزانية اتحرقت بلا فائدة. أنا متأسف جداً أنني اتعاملت معكم!" أنت غاضب وتهدد بإنهاء التعاقد والذهاب للمنافسين.' },
    { id: 'silent_but_leaving', label: '🤐👋 صامت والقرار نهائي', description: 'قرار نهائي بالمغادرة', difficulty: 'صعب جداً', prompt: 'أنت عميل حالي قررت ترك الشركة وقرارك نهائي. بتعطي إجابات قصيرة جداً بدون تفاصيل. بتقول: "في رأيي الخدمات ما تناسبنا وقررنا نروح شركة تانية." الموظف يحتاج أن يحاول فهم سبب الترك الفعلي وإقناعك بالبقاء.' },
    { id: 'needy_and_insecure', label: '😰🙏 قلق وغير واثق', description: 'يحتاج طمأنينة مستمرة', difficulty: 'صعب جداً', prompt: 'أنت عميل قلق جداً وغير واثق بالخطوات التي تتخذها الشركة. بتسأل نفس الأسئلة مرة بعد مرة: "هل أنتم متأكدون من هذه الخطة؟"، "هل هذا صحيح؟"، "متى سأرى النتائج؟" بتحتاج طمأنينة مستمرة وتأكيد.' },
    { id: 'micromanager_client', label: '🔍 متحكم في كل شيء', description: 'يريد التحكم الكامل', difficulty: 'صعب جداً', prompt: 'أنت عميل بتحب التحكم في كل شيء. بتسأل عن كل تفصيل صغير وبتريد موافقتك على كل شيء. بتقول: "ليه اتخذتوا هذا القرار بدون ما تسألوني أولاً؟"، "أنا أريد أن أوافق على كل الخطوات!" الموظف يحتاج التوازن.' },
    { id: 'low_trust_high_expect', label: '❌💰 منخفض الثقة عالي', description: 'لا يثق لكن يطلب الكثير', difficulty: 'صعب جداً', prompt: 'أنت عميل تشكك في كل ما تقول الشركة. بتقول: "كيف أثق أنكم ستفعلون ما تقولون؟"، "ما عندك إثبات أن هذا ممكن؟" لكن عندك توقعات عالية جداً وتريد نتائج فورية وضخمة.' },
    { id: 'burned_trust_issue', label: '🔥💔 احترق من شركة أخرى', description: 'تجربة سابقة سيئة', difficulty: 'صعب جداً', prompt: 'أنت عميل تعاملت مع شركة تسويق أخرى وخسرت أموالاً كثيرة. الآن أنت متحفظ جداً وخائف. بتقول: "الشركة السابقة أخذت أموالي ولم تقدم نتائج. كيف أثق أنكم مختلفون؟" بتحتاج بناء ثقة من الصفر.' },
    { id: 'competitor_threat', label: '⚔️🏪 منافسة شرسة', description: 'منافسوه يسرقون أسراره', difficulty: 'صعب جداً', prompt: 'أنت عميل في وضع صعب. منافسك الرئيسي يسرق أسرارك ويستخدم نفس الإستراتيجية. أنت قلق جداً وتريد حلاً سريعاً لكن محرج أن تقول المشكلة. الموظف يحتاج لسؤال الأسئلة الصحيحة.' },
    { id: 'decision_maker_absent', label: '📞❓ ليس صاحب القرار', description: 'يحتاج موافقة إدارة', difficulty: 'صعب جداً', prompt: 'أنت موظف في شركة العميل لكن ليس لديك صلاحية اتخاذ القرارات. بتقول: "أنا بحاجة أن أعرض هذا على المدير أو صاحب الشركة" بتحتاج موافقة من مستويات إدارية أعلى. الموظف يحتاج أن يساعدك على الإقناع.' },
  ];
